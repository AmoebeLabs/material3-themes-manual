...
##:material-home-floor-3: Automatic install using HACS

By the time this card is released, it will become available in HACS.

##:material-home-floor-3: Manual install (for Beta 0.9.0-b2, January 2022)
...
##:material-home-floor-3: Examples dashboard install
